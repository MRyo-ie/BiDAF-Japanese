...
class SQuAD_Data(TaskData):
    def __init__(self, local_dirpath, squad_version):
        ...
        self._local_dirpath = local_dirpath
        ...
        self.train_fpath = os.path.join(self._local_dirpath, self._train_fname)
        self.val_fpath = os.path.join(self._local_dirpath, self._val_fname)

...
class PreprocessSQuAD():
    def __init__(self):
        self.DOWNLOAD_DATA_URL = "https://rajpurkar.github.io/SQuAD-explorer/dataset/"
        np.random.seed(42)
    ...
    def maybe_download(self, base_url, filename, destination_dir, show_progress=True):
    ...
    def preprocess_and_write(self, dataset, tier, out_dir, squad_version, do_lowercase):
